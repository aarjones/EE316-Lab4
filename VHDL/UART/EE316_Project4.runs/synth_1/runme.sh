...
HD_PWD='C:/Users/Cole/Documents/GitHub/EE316-Lab4/VHDL/UART/EE316_Project4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_user.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_user.tcl
